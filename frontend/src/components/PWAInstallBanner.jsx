...
export default function PWAInstallBanner() {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto border rounded-2xl shadow-2xl p-4 flex flex-col sm:flex-row items-center justify-between gap-4 font-['Space_Grotesk']" style={{ background: 'var(--surface)', borderColor: 'var(--border)', borderRadius: 'var(--radius-lg)' }}>
        
        <div className="flex items-center gap-3 w-full sm:w-auto">
          <img src="/favicon.svg" alt="PitchPulse" className="w-10 h-10 object-contain flex-shrink-0" />
          <div className="flex flex-col">
            <span className="font-bold text-base leading-tight" style={{ color: 'var(--text)' }}>PitchPulse</span>
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto justify-end">
          {isIOS ? (
            <div className="text-xs font-medium px-3 py-2 rounded-lg text-center flex-1 sm:flex-none whitespace-nowrap" style={{ color: 'var(--accent)', backgroundColor: 'var(--accent-soft)', border: '1px solid var(--accent-border)' }}>
